...
<div class="container">`
	...
	<div class="jumbotron">
	    <h2 align="center"><a class="btn btn-lg btn-success" href="${pageContext.request.contextPath}/institute/secured/student/students"><i class="glyphicon glyphicon-cloud"></i> Show Students</a></h2>
	    <h2 align="center"><a class="btn btn-lg btn-success" href="${pageContext.request.contextPath}/institute/secured/student/add"><i class="glyphicon glyphicon-cloud"></i> Add Students</a></h2>
	</div>
